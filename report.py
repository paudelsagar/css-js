...
class Report:
    ...
    def pairplot1(self, df: pd.DataFrame, include_cols: Optional[List[str]] = None,
                 exclude_cols: Optional[List[str]] = None, class_name: Optional[str] = None,
                 max_plots: Optional[int] = None, height: int = 100,
                 mark_point_size: int = 1,
                 return_html: bool = False) -> Optional[str]:
        numeric_cols = df.select_dtypes(include=["number"]).columns.tolist()
        if include_cols:
            numeric_cols = [col for col in numeric_cols if col in include_cols]
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12"> <!-- Col Start -->
                <div class="card">
